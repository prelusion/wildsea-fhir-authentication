...
describe("FHIR API", function () {
    ...
    describe("Role | Patient", function () {
        ...
        before(async function () {
            ...
            patientAccount = {user:{ email: "Delano@NoToken", fhir_id: "49", password: "TestCase01", role: "patient"}}
            anotherPatientAccount = {user:{ email: "Another@NoToken", fhir_id: "3982", password: "TestCase01", role: "patient"}}
        ...
        describe("Resource | Observation", function () {
            it("Patient should get observation resource with correct API request", async function () {
                const response = await getResource("77", patientAccount.tokens.token, "Observation");
            ...
            it("Patient shouldn't be able to delete an observation resource", async function () {
                const response = await deleteResource("77", patientAccount.tokens.token, "Observation");
