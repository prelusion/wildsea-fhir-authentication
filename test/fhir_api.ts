...
describe("FHIR API", function () {
    ...
    describe("Role | Patient", function () {
        ...
        before(async function () {
            ...
            anotherPatientAccount = {user:{ email: "Another@NoToken", fhir_id: "481", password: "TestCase01", role: "patient"}}
    ...
    //             const response = await getResource("2", patientAccount.tokens.token, "Observation");
